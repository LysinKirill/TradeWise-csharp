...
{
    [property: Required(ErrorMessage = "InstrumentId required")] public required string InstrumentId { get; init; }
    [property: Required(ErrorMessage = "StatType required")] public required StatType StatType { get; init; }
