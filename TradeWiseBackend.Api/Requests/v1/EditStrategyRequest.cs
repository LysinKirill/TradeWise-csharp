...
public record class EditStrategyRequest(
    [param: Required(ErrorMessage = "StrategyId required")]
    Guid? StrategyId,
    [param: Required(ErrorMessage = "Title required")]
    string? Title,
    string? Description,
    [param: Required(ErrorMessage = "StrategyStages required")]
    List<StrategyStage> StrategyStages,
    [param: Required(ErrorMessage = "StrategyTransitions required")]
