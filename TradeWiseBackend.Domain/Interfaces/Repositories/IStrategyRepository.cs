...
public interface IStrategyRepository
{
    ...
    Task SaveStrategyStages(List<StrategyStage> strategy, CancellationToken ct);
    Task SaveStrategyTransitions(List<StrategyTransition> transitions, CancellationToken ct);
    ...
    Task UpdateStageExecutionStatusByStageExecutionId(Guid stageExecutionId, StageExecutionStatus status,
        CancellationToken ct);

    Task UpdateStrategyExecutionStatusByStrategyExecution(Guid strategyExecutionId, StrategyExecutionStatus status,
        CancellationToken ct);
    ...
    Task<List<StrategyExecutionInfo>> FetchPendingAndRunningStrategies(CancellationToken ct);

    Task<List<StageExecutionInfo>> FetchPendingStageExecutionsByStrategyExecutionId(Guid strategyExecutionId,
        CancellationToken ct);

    Task<List<StrategyTransition>> FetchTransitionByDestinationStage(Guid stageId, CancellationToken ct);

    Task<StageExecutionInfo> FetchStageExecutionByStageIdAndStrategyExecution(Guid stageId, Guid strategyExecutionId,
        CancellationToken ct);
