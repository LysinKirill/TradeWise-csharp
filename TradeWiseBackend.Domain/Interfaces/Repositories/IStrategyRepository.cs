...
{
    Task SaveStrategyStages(List<RepositoryModels.StrategyStage> strategy);
    Task SaveStrategyTransitions(List<RepositoryModels.StrategyTransition> transitions);
    ...
    Task UpdateUsedBudgetAsync(Guid strategyExecutionId, double newUsedBudget, CancellationToken ct);
}